                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about__image">
                            <img src="{{ empty($data['about']['about_image']) ? asset('frontend/assets/img/banner/banner_img.png') : asset($data['about']['about_image']) }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <div class="about__exp">
                                ...
                                <div class="about__exp__content">
                                    <p><span>{{ $data['about']['short_title'] }}</span></p>
                                </div>
                            </div>
                            <p class="desc">{{ $data['about']['short_description'] }}</p>
                        ...
                        <div class="about__info__wrap">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="about" role="tabpanel"
                                    ...
                                    <p class="desc">{!! $data['about']['long_description'] !!}</p>
                                    </li>
                                    </ul>
                                </div>
