    ...
    <main>
        ...
        <section class="banner">
                ...
                <div class="row align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <div class="banner__img text-center text-xxl-end">
                            <img src="{{ empty($data['home_slide']['home_slide']) ? asset('frontend/assets/img/banner/banner_img.png') : asset($data['home_slide']['home_slide']) }}" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>{{ $data['home_slide']['title'] }}</span></h2>
                            <p class="wow fadeInUp" data-wow-delay=".4s">{{ $data['home_slide']['short_title'] }}</p>
            ...
            <div class="banner__video">
                <a href="{{ $data['home_slide']['video_url'] }}" class="popup-video"><i class="fas fa-play"></i></a>
