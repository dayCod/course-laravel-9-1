                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" value="{{ old('name') }}" id="name"
                                        name="name" type="text" required placeholder="Name" autofocus />
                                </div>
                            </div>

                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" value="{{ old('username') }}" id="username"
                                        name="username" type="text" required placeholder="Username" autofocus />
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" value="{{ old('email') }}" id="email"
                                        name="email" type="email" required placeholder="Email" autofocus />
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" id="password_confirmation" name="password_confirmation"
                                        type="password" required placeholder="Password Confirmation" autofocus />
                                </div>
                            </div>
